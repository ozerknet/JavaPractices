...
public class SelfIntro {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("I am currently living in: MCLean");
        System.out.println("My favorite book is: JAVA");
        System.out.println("My favorite TV show is: JAVA");
        System.out.println("My favorite sport is: Soccer");
        System.out.println("My dream job is: SDET");

    }

}
/*
3. Create a class named SelfIntro and print the following information
about you:
        1. Hello Cydeo!
        2. My name is: Name
        3. I am From: Country
